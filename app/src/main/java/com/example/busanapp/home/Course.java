...
public class Course {
    ...
    */
    ...
    public Course(String title, String category, String description
            ...
            , String description8, String description9, String description10

            , int thumbnail, int thumbnail2, int thumbnail3
            , int thumbnail4, int thumbnail5, int thumbnail6
            , int thumbnail7, int thumbnail8, int thumbnail9, int thumbnail10) {
        Title = title;
        Category = category;
